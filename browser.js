const net = require("net");
 ...
 if (process.argv.length < 7){
  console.log(`  Usage: https://target.com 60 100 10 proxy.txt`); 
	 process.exit();}
 const headers = {};
 ...
 const cplist = [ // Captcha by focket 10-04-2023
 ...
 class NetSocket {
  ...
  HTTP(options, callback) {
     const parsedAddr = options.address.split(":"); // Socket Connection Fixed focket 27-03-2023
     ...
     connection.on("data", chunk => { //HTTP Version Fixed focket 08-04-2023
